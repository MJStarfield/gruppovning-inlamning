...
const LivingOption = [
  item('tent', 'Partält', 'Välj vårat härliga tvåmanna tält som ligger längs skogskanten med sikt mot sjön ', 199, 'Tent0', './assets/parTent.jpg'),

  item('tent', 'Familjetält', 'Välj vårat härliga familjetält som rymmer (5 personer), som ligger i den lilla skogsdungen nära nöjesparken ', 599, 'Tent3', './assets/familjeTent.jpg'),

  item('tent', 'Solotält', 'Välj vårat härliga enmanstält som ligger uppe nära och bra till hiking rundan', 159, 'Tent7', './assets/enmansTent.jpg'),
